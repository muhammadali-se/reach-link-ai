...
import { Copy, CheckCircle2, ArrowLeft, Lightbulb, CreditCard as Edit3 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-5 mb-8">
          {results.map((result, index) => (
            ...
            >
              <div className="flex items-center justify-between px-5 py-3 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold text-sm">
                    {index + 1}
                  </div>
                  <span className="text-sm font-semibold text-gray-700">
                    {mode === 'generate' ? 'Post Idea' : 'Optimized Version'}
                  </span>
                </div>
                <button
